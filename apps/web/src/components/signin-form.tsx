...
export function SignInForm() {
    ...
    async function onSubmit(data: Inputs) {
        ...
        try {
            ...
            const response = await fetch(`${process.env.NEXT_PUBLIC_NESTJS_SERVER}/role?email=${data.email}`);
            ...
            switch (firebaseError.code) {
                ...
                case 'auth/user-not-found':
                    toast({ variant: "destructive", title: 'Error', description: 'No se encontró un usuario con ese correo electrónico' });
                    break;
                default:
